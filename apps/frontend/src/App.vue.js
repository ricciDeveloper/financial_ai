...
if (__VLS_ctx.route.name !== 'login') {
    ...
    const __VLS_121 = {}.QItem;
    /** @type {[typeof __VLS_components.QItem, typeof __VLS_components.qItem, typeof __VLS_components.QItem, typeof __VLS_components.qItem, ]} */ ;
    // @ts-ignore
    const __VLS_122 = __VLS_asFunctionalComponent(__VLS_121, new __VLS_121({
        ...{ 'onClick': {} },
        clickable: true,
        ...{ class: "border-radius-item q-mb-sm transition-ease text-negative" },
    }));
...
const __VLS_141 = {}.QPageContainer;
